...
extensions = ['sphinx.ext.autodoc', 'sphinx.ext.viewcode', 'alabaster', 'releases']

releases_issue_uri = "https://github.com/getslash/vintage/issues/%s"
releases_release_uri = "https://github.com/getslash/vintage/tree/%s"
...
project = u'Vintage'
copyright = u'2013, Slash Developers'
...
latex_documents = [
  ('index', 'Vintage.tex', u'Vintage Documentation',
...
man_pages = [
    ('index', 'vintage', u'Vintage Documentation',
     [u'Rotem Yaari'], 1)
]
...
texinfo_documents = [
  ('index', 'Slash', u'Slash Documentation',
   u'Rotem Yaari', 'Vintage', 'One line description of project.',
   'Miscellaneous'),
]
